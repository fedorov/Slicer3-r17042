/*=========================================================================
  ...
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/branches/Slicer-3-6/Base/Logic/vtkSlicerApplicationLogic.h $
  Language:  C++
  Date:      $Date: 2011-01-30 12:52:29 -0500 (Sun, 30 Jan 2011) $
  Version:   $Revision: 15857 $
