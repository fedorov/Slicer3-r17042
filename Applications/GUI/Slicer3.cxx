/*=========================================================================
  ...
  Program:   Slicer3
  Language:  C++
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/branches/Slicer-3-6/Applications/GUI/Slicer3.cxx $
  Date:      $Date: 2011-05-12 10:44:00 -0400 (Thu, 12 May 2011) $
  Version:   $Revision: 16610 $
...
void printAllInfo(int argc, char **argv)
{
  ...
  fprintf(stdout, "<ProgramName version=\"$Revision: 16610 $\">%s</ProgramName>\n", argv[0]);
...
#endif
  fprintf(stdout, "<Repository>$HeadURL: http://svn.slicer.org/Slicer3/branches/Slicer-3-6/Applications/GUI/Slicer3.cxx $</Repository>\n");
  fprintf(stdout, "<ProcessStep>\n");
  fprintf(stdout, "\n");
}
